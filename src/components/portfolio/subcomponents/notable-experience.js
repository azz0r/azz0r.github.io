...
export default class NotableXP extends React.Component {

  displayName = 'NotableXP'
  ...
  render() {
    return (
      <ul id="notable-experience" className="row">
          ...
          workBench</li>
          <li>Advising and implementing process to <strong>improve website speed</strong> (ySlow,
          Google PageSpeed, minification, bundling, image optimisations)</li>
          <li>Excellent mobile experience; ensuring BT.com is <strong>responsive</strong> across
          mobile, tablet and desktop</li>
          <li>DevOps experience advising on deployment processes, server set up &
          requirements</li>
          <li>Running a democratic <strong>design council</strong> with senior front-end
          developers to vote on code rules & processes, discuss tools & libraries
          and agree on frameworks to use</li>
          <li>Created and enforced code standards by putting <strong>pull request &
          reviews</strong> at the core of code delivery. Seconded only by enforcing code
          lint standards pass 100% before being able to commit</li>
          <li>Technically advised on <strong>Backbone, React</strong> & Angular project
          deliveries</li>
